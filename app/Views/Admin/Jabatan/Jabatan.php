...
<div class="table-wrapper">
    <a href="<?= base_url('Admin/Jabatan/Create') ?>" class="btn btn-primary tambah-btn">
            ...
            <?php foreach ($jabatan as $jab): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= base_url('Admin/Jabatan/Delete/' . $jab['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?')">
